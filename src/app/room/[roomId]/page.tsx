    ...
    <main className="flex flex-col h-screen max-h-screen overflow-hidden">
        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={copyLink}
                className="text-[10px] bg-zinc-800 hover:bg-zinc-700 px-2 py-0.5 rounded-lg text-zinc-400 hover:text-zinc-200 transition-colors"
              >
                {copyStatus}
              </button>
            </div>
      ...
      <div className="flex-1 p-4 space-y-4 overflow-y-scroll">
        ...
        {messages?.messages.map((msg) => (
          ...
          >
            <div className="max-w-[80%] p-2 group rounded-md border border-zinc-800">
        ...
        <div className="flex gap-4">
          <div className="flex-1 relative group">
            ...
            <input
              ...
              className="w-full bg-black border border-zinc-800 focus:border-zinc-700 focus:outline-none transition-colors text-zinc-100 rounded-lg placeholder:text-zinc-700 py-3 pl-8 pr-4 text-sm"
            />
          </div>
